    ...
    return (
        ...
        >
            ...
            ${status === "In Progress" ? 'border-cyan-500' : status === 'Completed' ? 'border-indigo-500' : 'border-violet-500'}`}>
                ...
                <p className='text-xs text-gray-500 mt-1.5 lime-clam-2 leading-[18px]'>
                    {description}
                </p>
            ...
            <div className='px-4'>
                <div className='flex items-center justify-between my-1'>
                    ...
                    <div>
                        <label className='test-xs text-gray-500'>Due Date</label>
                        <p className='text-[13px] font-medium text-gray-900'>
                    ...
                    <AvatarGroup avatars={assignedTo || 0} />
                    {
                        attachmentCount > 0 && (
                            <div className='flex items-center gap-2 bg-blue-50 px-2.5 py-1.5 rounded-lg'>
                                <LuPaperclip className='bg-blue-500' /> {' '}
